...
def adminlist(bot, trigger):
  if trigger.nick == 'Reception123':
    bot.say(trigger.nick + ', the bot\'s admins are: paladox, You, SwisterTwister and Zppix.')
    ...
    bot.say(trigger.nick + ', the bot\'s admins are: paladox, Reception123, You and Zppix.')
  elif trigger.nick == 'paladox':
    bot.say(trigger.nick + ', the bot\'s admins are: You, Reception123, SwisterTwister and Zppix.')
  else:
    bot.say(trigger.nick + ', the bot\'s admins are: paladox, Reception123, SwisterTwister and Zppix.')
