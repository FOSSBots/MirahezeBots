...
def ping_converse(bot, trigger):
    ...
    elif trigger.nick == 'wm-bot' or trigger.nick == 'wm-bot2' or trigger.nick == 'wm-bot3' or trigger.nick == 'Source-Zppixbot' or trigger.nick == 'wikibugs' or trigger.nick == 'wikibugs_':
        return  
