...
def blockManager(actiontype, sender, iswikifarm, domain, acl, logininfo, trigger):
...
def blockuser(bot, trigger):
    ...
    replytext = blockManager('block', [trigger.nick, trigger.account], bot.settings.wikimgnt.wiki_farm,
