...
We currently support with security releases: the lastest PyPi version on the Master branch, and the Dev branch when running sopel 7.0.5 - 8.0 on python 3.6, 3.7, and 3.8.
